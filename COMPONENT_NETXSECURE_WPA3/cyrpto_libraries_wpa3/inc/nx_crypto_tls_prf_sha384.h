...
typedef struct NX_CRYPTO_TLS_PRF_SHA384_STRUCT
{
    ...
    UCHAR nx_secure_tls_prf_temp_A_buffer[136]; /* The temp_A buffer needs to be large enough to holdthe lable(21 bytes) || prf_seed(64 bytes) || hash_size(48 bytes for SHA384) */
