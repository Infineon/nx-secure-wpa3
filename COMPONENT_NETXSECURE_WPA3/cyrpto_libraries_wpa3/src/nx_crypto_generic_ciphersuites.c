...
NX_SECURE_TLS_CRYPTO nx_crypto_tls_ciphers =
{
    ...
    /* IFX: WPA3 Changes : Add crypto method for SHA384 and TLS PRF SHA384 */
...
#ifdef NX_SECURE_ENABLE_AEAD_CIPHER
	/* IFX: WPA3 Changes : Add support for TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 and for these AEAD Cipher the Hash Method is set to Null as per RFC spec */
