...
/* IFX: WPA3 Changes */
#define NX_SECURE_TLS_MAX_HASH_SIZE                        (48)  /* This is the largest size a single hash/MAC for ANY session *might* be, in bytes. */
...
typedef struct NX_SECURE_TLS_HANDSHAKE_HASH_STRUCT
{
    ...
    /* IFX: WPA3 Changes : Add support for SHA384 crypto hash context */	
	/* SHA-384 handshake hash context. */
	CHAR *nx_secure_tls_handshake_hash_sha384_metadata;
	ULONG nx_secure_tls_handshake_hash_sha384_metadata_size;
	VOID *nx_secure_tls_handshake_hash_sha384_handler;
...
typedef struct NX_SECURE_TLS_CRYPTO_STRUCT
{
    ...
    /* IFX: WPA3 Changes : Add support for SHA384 crypto and TLS PRF SHA384  */
	const NX_CRYPTO_METHOD *nx_secure_tls_handshake_hash_sha384_method;
	const NX_CRYPTO_METHOD *nx_secure_tls_prf_sha384_method;
#endif
...
/* IFX: WPA3 Changes */
typedef UINT (*cy_tcp_socket_send_t)(void *opaque, NX_PACKET *packet_ptr, ULONG wait_option);
typedef UINT (*cy_tcp_socket_receive_t)(void *opaque, NX_PACKET **packet_ptr, ULONG wait_option);
...
typedef struct NX_SECURE_TLS_SESSION_STRUCT
{
    ...
    /* IFX: WPA3 Changes */
    UINT                    cy_tcp_ip_version;
    cy_tcp_socket_send_t    cy_tcp_socket_send;
    cy_tcp_socket_receive_t cy_tcp_socket_receive;
    void                    *cy_tcp_opaque;
...
UINT _nx_secure_tls_session_start(NX_SECURE_TLS_SESSION *tls_session, NX_TCP_SOCKET *tcp_socket,
                                  UINT wait_option);
/* IFX: WPA3 Changes */
UINT cy_nx_secure_tls_session_start(NX_SECURE_TLS_SESSION *tls_session, cy_tcp_socket_send_t cy_tcp_socket_send,
                                    cy_tcp_socket_receive_t cy_tcp_socket_receive, UINT wait_option,
                                    UINT cy_tcp_ip_version, UINT session_type_server, NX_PACKET_POOL *packet_pool,
                                    void *cy_tcp_opaque);
