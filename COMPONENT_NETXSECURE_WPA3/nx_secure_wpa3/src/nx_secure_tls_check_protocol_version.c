...
NX_SECURE_TLS_VERSIONS nx_secure_tls_supported_versions[] =
{
    {NX_SECURE_TLS_VERSION_SSL_3_0, NX_SECURE_TLS_SSL_3_0_ENABLED},   /* SSLv3   */
    {NX_SECURE_TLS_VERSION_TLS_1_0, 0},                               /* TLS 1.0 */
    {NX_SECURE_TLS_VERSION_TLS_1_1, 0},                               /* TLS 1.1 */
...
NX_SECURE_TLS_VERSIONS nx_secure_dtls_supported_versions[] =
{
    {NX_SECURE_DTLS_VERSION_1_0, 0},                                  /* DTLS 1.0 */
...
{
    {(const NX_SECURE_TLS_VERSIONS *)nx_secure_tls_supported_versions, sizeof(nx_secure_tls_supported_versions) / sizeof(NX_SECURE_TLS_VERSIONS)},
#ifdef NX_SECURE_ENABLE_DTLS
    {(const NX_SECURE_TLS_VERSIONS *)nx_secure_dtls_supported_versions, sizeof(nx_secure_dtls_supported_versions) / sizeof(NX_SECURE_TLS_VERSIONS)},
#endif /* NX_SECURE_ENABLE_DTLS */
};
