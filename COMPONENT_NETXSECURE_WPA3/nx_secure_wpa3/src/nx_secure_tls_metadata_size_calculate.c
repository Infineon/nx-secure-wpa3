...
/*ULONG nx_crypto_metadata_area_size = 0;*/
	...
	/* IFX: WPA3 Changes to add SHA256 metadata size */
    max_handshake_hash_metadata_size += crypto_table -> nx_secure_tls_handshake_hash_sha256_method -> nx_crypto_metadata_area_size;

	/* IFX: WPA3 Changes to add SHA384 metadata size */
	max_handshake_hash_metadata_size += crypto_table ->nx_secure_tls_handshake_hash_sha384_method -> nx_crypto_metadata_area_size;
#endif
    ...
    if (max_tls_prf_metadata_size < crypto_table -> nx_secure_tls_prf_sha384_method -> nx_crypto_metadata_area_size)
    {
